...
String apiKey = "G208EU4L0M9N2SSF";     //  Enter your Write API key from ThingSpeak

const char *ssid =  "nandani@123";     // replace with your wifi ssid and wpa2 key
const char *pass =  "nandani@123";
